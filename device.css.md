...
### Copyright
Devices are created with CSS magic by Alex Inkin, project managed by [Timur Tatarshaov](http://famer.github.io). You are free to use it anywhere according to MIT license.
© 2015
